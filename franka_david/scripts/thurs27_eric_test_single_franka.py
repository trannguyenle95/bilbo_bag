...
if __name__ == '__main__':
   ...
   dt = 4 #1/30 #/ 120 #NOTE: modify this to match generated CSV or set this FPS when generating csv!
   ...
   traj = np.genfromtxt("20fps_DMP_BagFlip.csv", delimiter=',') #NOTE: set name here!
