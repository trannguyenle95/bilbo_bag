...
%     plot_TC_DMPvel = plot(0:1/1000:1/1000*(length(TC_DMPpos)-1),TC_DMPpos(:,joint),'b-','LineWidth',5.5, 'DisplayName','UC-TC-DMP');
%     plot_Opt_DMPvel = plot(0:1/1000:1/1000*(length(Opt_DMPpos)-1),Opt_DMPpos(:,joint),'r-','LineWidth',3.5, 'DisplayName','UC-Opt-DMP');
...
for joint = 1:7
    ...
    hold on
    plot_demo = plot(demo_traj.t,demo_traj.pos(joint,:),'g-','LineWidth',7.5, 'DisplayName','demo');
    plot_TC_DMPpos = plot(0:1/1000:1/1000*(length(TC_DMPpos)-1),TC_DMPpos(:,joint),'b-','LineWidth',4.5, 'DisplayName','UC-TC-DMP');
    plot_Opt_DMPpos = plot(0:1/1000:1/1000*(length(Opt_DMPpos)-1),Opt_DMPpos(:,joint),'r-','LineWidth',1.5, 'DisplayName','UC-Opt-DMP');
    legend([plot_demo, plot_TC_DMPpos, plot_Opt_DMPpos], 'Location','northwest')
end
...
%     hold on
%     plot_demo = plot(demo_traj.t,demo_traj.vel(joint,:),'g-','LineWidth',5.5, 'DisplayName','demo');
%     plot_TC_DMPvel = plot(0:1/1000:1/1000*(length(TC_DMPvel)-1),TC_DMPvel(:,joint),'b-','LineWidth',3.5, 'DisplayName','UC-TC-DMP');
%     plot_Opt_DMPvel = plot(0:1/1000:1/1000*(length(Opt_DMPvel)-1),Opt_DMPvel(:,joint),'r-','LineWidth',1.5, 'DisplayName','UC-Opt-DMP');
%     legend([plot_demo, plot_TC_DMPvel, plot_Opt_DMPvel])
% end
...
for joint = 1:7
    ...
    plot_TC_DMPvel = plot(0:1/1000:1/1000*(length(TC_DMPvel)-1),TC_DMPvel(:,joint),'b-','LineWidth',4.5, 'DisplayName','UC-TC-DMP');
    plot_Opt_DMPvel = plot(0:1/1000:1/1000*(length(Opt_DMPvel)-1),Opt_DMPvel(:,joint),'r-','LineWidth',1.5, 'DisplayName','UC-Opt-DMP');
    legend([plot_demo, plot_TC_DMPvel, plot_Opt_DMPvel], 'Location','northwest')
end
